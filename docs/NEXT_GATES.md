...
- [ ] Zhuang & Shen PSF-mismatch AGN-host benchmark — C5b run `33705072892` succeeded; all 400 grid points/six refinements reviewed. The n=4 zero-host plateau hides a lower-cost nonzero-host solution, still bound-limited and physically biased. C5c `gate-c-agn-psf-de` uses pinned SciPy population-based search on the unchanged objective before further PSF effects. Empirical/core-wing, chromatic and centroid questions remain open; see `benchmarks/zhuang_shen_2024/REVIEW.md`.
