...
- [ ] Zhuang & Shen PSF-mismatch AGN-host benchmark — actual C5d–C5i and C5k–C5n artifacts reviewed; C5j and C5m remain incomplete LOCAL diagnostics with preserved memory-cap failures. C5o matched-PSF run `33819349854` had a split result and did not pass. C5p `33823405733` succeeded as a diagnostic and shows module/solver-dependent local basins: Nelder--Mead compact-host solutions have 32--89 times worse SSE than the lower-cost solutions, while module-A LM retains its timeout. C5q now freezes two seeded Imfit DE-LHS searches without changing images, bounds, objective or resource cap. See `benchmarks/zhuang_shen_2024/C5O_PROTOCOL.md`, `C5P_PROTOCOL.md`, `C5Q_PROTOCOL.md`, `c5p_33823405733.json` and `REVIEW.md`. Signed wings remain non-photon-ready. Physical/chromatic PSF and survey-readiness remain open; do not start wrong-PSF free-shape fitting before C5q review.
