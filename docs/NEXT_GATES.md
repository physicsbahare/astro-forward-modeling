...
- [ ] Zhuang & Shen PSF-mismatch AGN-host benchmark — actual C5d–C5i and C5k–C5n artifacts reviewed; C5j and C5m remain incomplete LOCAL diagnostics with preserved memory-cap failures. C5n `33806193712` and its repair rerun `33810187864` succeeded, but compact-corner sampling drift remains up to 0.273% and cross-code differences up to 1.940%; neither renderer is truth. C5o now freezes a matched-PSF, noiseless Imfit free-shape preflight at only the nominal Re=16, q=0.6, n=1/4 anchors before a separately frozen wrong-PSF arm. See `benchmarks/zhuang_shen_2024/C5O_PROTOCOL.md`, `imfit_bounded_33806193712.json` and `REVIEW.md`. Signed wings remain non-photon-ready. Physical/chromatic PSF and survey-readiness remain open; C5o is not yet a GitHub-success claim.
