...
- [ ] Zhuang & Shen PSF-mismatch AGN-host benchmark — C5a run `33701100594` succeeded; 18 winners/54 starts reviewed, five bound-hit winners. C5b `gate-c-agn-psf-plateau` searches the zero-host NNLS plateau with a frozen structural grid and three diagnostic restarts before adding further PSF effects. Empirical/core-wing, chromatic and centroid questions remain open; see `benchmarks/zhuang_shen_2024/REVIEW.md`.
