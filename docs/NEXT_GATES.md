...
- [ ] Zhuang & Shen PSF-mismatch AGN-host benchmark — C5a `gate-c-agn-psf-width` freezes noiseless Gaussian width factors 0.97/1/1.03 with independent archived truth and unchanged fitting bounds. Empirical/core-wing, chromatic and centroid questions remain open; see `benchmarks/zhuang_shen_2024/REVIEW.md`.
