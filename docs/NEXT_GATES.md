...
- [ ] AGN nuclear-fraction morphology contamination benchmark — Stage-0 anchors initiated in `benchmarks/agn_nuclear_fraction/REVIEW.md`; perfect-PSF/noiseless isolation comes before noise or PSF mismatch.
